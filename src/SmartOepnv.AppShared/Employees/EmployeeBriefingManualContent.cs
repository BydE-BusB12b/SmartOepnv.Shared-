    ...
    [
        new BriefingSection(
            ...
            • Verwenden Sie die Pause-Funktion im Menü, wenn Sie das Gerät kurzzeitig unbeaufsichtigt lassen.
              Während der Pause bleiben Sie angemeldet; zum Fortfahren geben Sie Ihr Anmeldepasswort erneut ein (siehe Abschnitt 7).
        ...
        new BriefingSection(
            "2. ITCS – Fahren und Linienbetrieb",
            """
            ...
            • Wählen Sie vor Abfahrt Linie/Kurs und Fahrt aus – Ablauf in Abschnitt 8; prüfen Sie Zielanzeige und Fahrtrichtung.
        ...
        new BriefingSection(
            "3. Pas.Info, Ansagen und Fahrgastinformation",
            """
            ...
            """),
        new BriefingSection(
            "4. Menü, Einstellungen und Kommunikation",
            """
            ...
            • Mängelkarte (gelb): Mängel am Fahrzeug melden – Details in Abschnitt 6.
            • Pause (rot): Gerät kurzzeitig sperren – Details in Abschnitt 7.
        ...
        new BriefingSection(
            "5. Zeitwirtschaft und Dokumente",
            """
