...
public static class SplitShiftCompliance
{
        ...
        out string errorMessage)
    {
        ...
        var workMs = (part1EndEpochMs - part1StartEpochMs) + (part2EndEpochMs - part2StartEpochMs);
        if (workMs > (long)(SplitShiftRules.MaxDailyWorkingHours * 60 * 60 * 1000))
        {
            errorMessage = SplitShiftRules.DailyWorkingTimeMessage;
            return false;
        }
